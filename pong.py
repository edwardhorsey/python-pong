...
paddle_a.speed(0) # Speed of animation for turtle module
paddle_a.shape("square")
paddle_a.color("white")
paddle_a.shapesize(stretch_wid=5, stretch_len=1)
paddle_a.penup() # so it doesn't draw a line the whole time
paddle_a.goto(-350, 0)
...
paddle_b.speed(0) # Speed of animation for turtle module
paddle_b.shape("square")
paddle_b.color("white")
paddle_b.shapesize(stretch_wid=5, stretch_len=1)
paddle_b.penup() # so it doesn't draw a line the whole time
paddle_b.goto(350, 0)

# Ball

ball = turtle.Turtle()
ball.speed(0) # Speed of animation for turtle module
ball.shape("square")
ball.color("yellow")
